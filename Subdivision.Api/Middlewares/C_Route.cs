...
namespace Subdivision.Api.Middlewares
{
    public class C_Route: IApplicationModelConvention
    {
        private readonly string _tokenRegex;
        private readonly Func<ControllerModel, string?> _valueGenerator;

        public C_Route(string tokenName, Func<ControllerModel, string?> valueGenerator)
        {
